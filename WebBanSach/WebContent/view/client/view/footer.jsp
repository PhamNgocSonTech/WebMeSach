		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-4 md-margin-bottom-40">
					...
					<p>Mọi bản quyền điều thuộc về mesach.com</p>
					<br>
					<ul class="list-unstyled address-list margin-bottom-20">
						<li><i class="fa fa-angle-right"></i>Thành phố Hồ Chí Minh - Việt Nam</li>
						<li><i class="fa fa-angle-right"></i>SĐT: 0973.983.546</li>
						<li><i class="fa fa-angle-right"></i>Hotline: 01299 725 789</li>
						<li><i class="fa fa-angle-right"></i>Email:
							mesach@gmail.com</li>
					</ul>
					<p> Theo dõi Mesach tại: </p>
				...
				<div class="col-md-2 col-sm-3">
					<div class="row">
						<div class="col-sm-12 col-xs-6">
							<h2 class="thumb-headline">Về MeSach</h2>
							<ul class="list-unstyled simple-list margin-bottom-20">
								<li><a href="#">Giới thiệu MeSach</a></li>
				...
				<div class="col-md-2 col-sm-3">
					<div class="row">
						<div class="col-sm-12 col-xs-6">
							<h2 class="thumb-headline">Liên hệ với Mesach</h2>
							<ul class="list-unstyled simple-list margin-bottom-20">
								<li><a href="#">Chat trực tuyến 24/7</a></li>
								<li><a href="#">Chính sách hàng nhập</a></li>
