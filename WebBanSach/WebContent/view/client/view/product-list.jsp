...
<body class="header-fixed">
	<div class="wrapper">
		...
		<div class="breadcrumbs-v4">
			<div class="container">
				<span class="page-name">Danh sách sản phẩm</span>
				<h1>
					Danh sách <span class="shop-green">sản phẩm</span> của bạn
				</h1>
									...
									<div class="col-sm-8 product-description">
										...
										<div class="overflow-h margin-bottom-5">
											...
											<div class="margin-bottom-10">
												<span class="title-price margin-right-10"><fmt:formatNumber value="${p.price}" /> VNĐ</span>
												<span class="title-price line-through"><fmt:formatNumber value="${p.price*1.5}" /> VNĐ</span>
											...
											<ul class="list-inline add-to-wishlist margin-bottom-20">
												<li class="wishlist-in"><i class="fa fa-heart"></i> <a
													href=""
													${pageContext.request.contextPath }/product/detail?id=${p.id}"">Thêm vào mục yêu thích</a></li>
												<li class="compare-in"><i class="fa fa-exchange"></i> <a
													href=""
													${pageContext.request.contextPath }/product/detail?id=${p.id}"">Thêm để so sánh</a></li>
											</ul>
											<a
