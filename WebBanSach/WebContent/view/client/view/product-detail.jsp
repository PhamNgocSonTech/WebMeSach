				...
				<div class="row">
					...
					<div class="col-md-6">
						...
						<ul class="list-inline product-ratings margin-bottom-30">
							...
							<li><i class="rating fa fa-star"></i></li>
							<li class="product-review-list"><span>(1) <a href="#">Lượt đánh giá</a>
						...
						<h3 class="shop-product-title" style="font-size: 15px"><b>Số lượng</b></h3>
						<div class="margin-bottom-40">
							...
							<form name="f1" class="product-quantity sm-margin-bottom-20"
								...
								<button type='button' class="quantity-button" name='add'
									...
									value='+'>+</button>
								<button type="submit" class="btn-u btn-u-sea-shop btn-u-lg" style="margin-left: 15px">Thêm vào giỏ hàng</button>
							</form>
...
<!-- 					<li><a href="#reviews" role="tab" data-toggle="tab">Reviews
		...
		<div class="container">
			<div class="heading heading-v1 margin-bottom-20">
				<h2>Cùng thể loại</h2>
				<p>Khám phá thêm những quyển sách hay cùng thể loại với sách của bạn</p>
			</div>
					...
					<a href="#"><img class="img-responsive" src="/WebBanSach/view/client/static/img/book-img/${product.image}" alt=""></a>
						<div class="product-description-v2">
							<div class="margin-bottom-5">
								...
								<span class="title-price line-through">$200.00</span>
							</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 md-margin-bottom-20">
						<h2>
							Cập nhật thông tin sách mới ? <strong>Để lại email cho chúng tôi</strong>
						</h2>
					</div>
					<div class="col-md-4">
